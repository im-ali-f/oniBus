...
class searchForm(forms.Form):
    ...
    finalDestination=forms.CharField(label="مقصد",required=True,error_messages={"required":"لطفا مقصد را وارد کنید"},widget=forms.TextInput(attrs={"class":"searchInput","id":"originDest"}))